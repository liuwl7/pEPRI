...
**1. Remove adapters and PCR duplicates, STAR map to genome and remove background (IgG)**
	
These steps using the RICpipe (https://github.com/caochch/RICpipe) and CRIC-seq (https://github.com/HuNaijing/CRIC-seq) pipelines.
	
**2. Define enhancer and promoter regions**

Enhancer and promoter regions for HeLa cells were defined as previously described (https://github.com/liangliangibp/Alu).
	
**3. Chimeric reads uniquely mapped to enhancers and promoters**
